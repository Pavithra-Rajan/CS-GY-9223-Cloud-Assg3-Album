...
apiGateway.core.utils = {
    ...
    copy: function (obj) {
        ...
        // Handle typed arrays explicitly
    ...
    mergeInto: function (baseObj, additionalProps) {
        ...
        var merged;
        // Typed arrays
        if (typeof Uint8Array !== 'undefined' && baseObj instanceof Uint8Array) {
            merged = new Uint8Array(baseObj);
        } else if (typeof ArrayBuffer !== 'undefined' && baseObj instanceof ArrayBuffer) {
            merged = baseObj.slice(0);
        } else if (Array.isArray(baseObj)) {
            merged = baseObj.slice(0);
        } else {
            merged = {};
